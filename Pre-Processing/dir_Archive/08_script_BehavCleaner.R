## BehavCleaner.R | v2022.07.21
  ...
  BehavCleaner <- function(file, # String containing the filename that must be cleaned
                        ...
                        shave_secs) # A numeric value denoting the interval of time, in seconds, that should be ignored/removed from the 
